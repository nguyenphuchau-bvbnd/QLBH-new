...
namespace QLBH.Application.Catalog.Products
{
    public class ManageProductService : IManageProductService
    {
        ...
        public ManageProductService(QLBHDbContext context, IStorageService storageService)
        {
            _context = context;
        ...
        public async Task<ProductViewModel> GetById(int productId, string languageId)
        {
            ...
            var image = await _context.ProductImages.Where(x => x.ProductId == productId && x.IsDefault == true).SingleOrDefaultAsync();
